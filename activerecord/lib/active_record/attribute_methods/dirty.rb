  ...
  module AttributeMethods
    module Dirty # :nodoc:
      ...
      included do
        ...
        class_attribute :autosave_serialized_attributes, instance_writer: false
        self.autosave_serialized_attributes = true
      end
      ...
      #
      def maybe_changed
        autosave_serialized_attributes? ? (attributes.keys & self.class.serialized_attributes.keys) : []
      end
    private
